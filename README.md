...
このリポジトリの公開正本は `v4.0-rc.1` です。現在の承認済み制作範囲は次の21単位です。
...
- `curriculum-v40.js` — PART 0＋全20課の公開範囲を組み立てる入口
- `app-v28.js` — ナビ、進捗、練習、音声、印刷（UI本体を段階移行中）
- `styles-v28.css` — モバイル・印刷スタイル
- `manifest-v40.webmanifest` / `sw.js` — PWAとオフラインキャッシュ
...
- データ・転写・教材構造：**17214 assertions**
- 厳密転写ゴールデンケース：**66件**
- 公開教材データ：**418項目**
- DOM・設定移行・音声イベント・全20課描画：**91 assertions**
- 公開範囲：**PART 0＋第1〜20課**
