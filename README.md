...
このリポジトリの公開正本は `v3.3-rc.1` です。現在の承認済み制作範囲は次の9単位です。
...
- `lesson07-v33.js` — 第7課
- `lesson08-v33.js` — 第8課
- `curriculum-v33.js` — 現在の公開範囲を組み立てる入口
- `app-v28.js` — ナビ、進捗、練習、音声、印刷（UI本体を段階移行中）
- `styles-v28.css` — モバイル・印刷スタイル
- `manifest-v33.webmanifest` / `sw.js` — PWAとオフラインキャッシュ
...
第3〜6課を含む `confidence.pronunciation:C` の項目は設計上公開可能ですが、ネイティブ音声監査待ちです。`D` は公開できません。
