...
このリポジトリの公開正本は `v3.4-rc.1` です。現在の承認済み制作範囲は次の9単位です。
...
単なる用語暗記や、教材外の珍しい語形を当てる問題にはしません。解答後には理由と「持ち帰る一行」を表示します。例文とTTS本文はv3.3から変更せず、説明と復習導線を改良しています。
...
- `curriculum-v34.js` — 現在の公開範囲を組み立てる入口
- `app-v28.js` — ナビ、進捗、練習、音声、印刷（UI本体を段階移行中）
- `styles-v28.css` — モバイル・印刷スタイル
- `manifest-v34.webmanifest` / `sw.js` — PWAとオフラインキャッシュ
