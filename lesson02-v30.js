(() => {
  ...
  const examples = [
    ...
    E({
      ...
      pronunciationRoman: "nīnga tayārā?",
      katakana: "ニーンガ タヤーラー？",
      meaningJa: "準備はできましたか？",
    ...
    E({
      ...
      pronunciationRoman: "enne kūppiḍunga.",
    ...
    E({
      ...
      pronunciationRoman: "nīnga enga pōrīnga?",
    ...
    E({
      ...
      pronunciationVariants: ["ongaḷukku taṇṇi vēṇumā?"],
    ...
    E({
      ...
      structuredRoman: "eṉ-akku atu piṭikkum.",
  ...
  const patterns = [
    ...
    E({
      ...
      pronunciationVariants: ["ongaḷukku"],
      katakana: "ウンガルック",
      kanaVariants: ["オンガルック"],
