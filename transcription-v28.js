...
(() => {
  ...
  if (reference) {
    addItem(reference.heroExample);
    for (const item of reference.examples ?? []) addItem(item);
  }
  ...
  const manualInlineGlosses = [
    ...
    ["படத்தை", "paḍatte", "パダッテ"],
    ["ரவியை பாத்தேன்", "raviye pāttēn", "ラヴィイェ パーッテーン"],
    ["அந்தப் படத்தை பாத்தேன்", "anda paḍatte pāttēn", "アンダ パダッテ パーッテーン"],
    ["ஒரு படம் பாத்தேன்", "oru paḍam pāttēn", "オル パダム パーッテーン"],
    ["படம் பாத்தேன்", "paḍam pāttēn", "パダム パーッテーン"],
  ...
  book.meta.edition = "音声・文字・格リファレンス版 v2.8";
  book.meta.transcriptionVersion = "2.8";
